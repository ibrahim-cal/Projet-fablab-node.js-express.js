...
router.get(
  '/facture/create', //checkPermission('creerFacture', 'manager'),
...
router.get(
  '/facture/:id/delete', //-- checkPermission('supprimerFacture', 'comptable'),
  facture_controller.facture_delete_get
);
// POST request to delete facture.
router.post(
  '/facture/:id/delete',
  checkPermission('supprimerFacture', 'comptable'),
...
router.get(
  ...
  ligneFacturation_controller.ligneFacturation_create_get
);
// POST request for creating ligneFacturation.
router.post(
  '/ligneFacturation/create',
  ligneFacturation_controller.ligneFacturation_create_post
);
// GET request for one ligneFacturation.
router.get(
  '/ligneFacturation/:id',
  ligneFacturation_controller.ligneFacturation_detail
);
// GET request for list of all ligneFacturation items.
router.get(
  '/ligneFacturations',
  ligneFacturation_controller.ligneFacturation_list
);
// GET request to delete ligneFacturation
router.get(
  '/ligneFacturation/:id/delete',
  ligneFacturation_controller.ligneFacturation_delete_get
);
// POST request to delete ligneFacturation
router.post(
  '/ligneFacturation/:id/delete',
  ligneFacturation_controller.ligneFacturation_delete_post
);
...
router.post(
  '/machine/:id/update', // checkPermission('modifierMachine', 'manager'),
...
router.get(
  '/utilisateur/create',
  utilisateur_controller.utilisateur_create_get
);
// POST request for creating utilisateur.
router.post(
  '/utilisateur/create',
  utilisateur_controller.utilisateur_create_post
);
// GET request to update utilisateur.
router.get(
  '/utilisateur/:id/update',
  utilisateur_controller.utilisateur_update_get
);
// POST request to update utilisateur.
router.post(
  '/utilisateur/:id/update',
  checkPermission('modifierUtilisateur', 'manager'),
...
router.get(
  '/utilisation/create',
  utilisation_controller.utilisation_create_get
);
// POST request for creating utilisation.
router.post(
  '/utilisation/create',
  utilisation_controller.utilisation_create_post
);
// GET request to delete utilisation.
router.get(
  '/utilisation/:id/delete',
  utilisation_controller.utilisation_delete_get
);
// POST request to delete utilisation.
router.post(
  '/utilisation/:id/delete',
  utilisation_controller.utilisation_delete_post
);
...
router.get(
  '/utilisations',
  checkPermission('lireUtilisation', 'membre'),
